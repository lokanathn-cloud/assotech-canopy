  ...
  return <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container-custom px-4 pt-20 pb-32">
        <div className="max-w-3xl">
          ...
          duration: 0.6,
          delay: 0.2
        }} className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl">Premium Plotted Development in Crossing Republik, Ghaziabad. Experience the freedom of design with 100 & 200 Sq. Yard plots.</motion.p>
