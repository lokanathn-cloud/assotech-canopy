...
const LeadForm = () => {
  ...
  if (isSubmitted) {
    return (
      <section id="lead-form" className="section-padding bg-primary/5">
  ...
  return (
    <section id="lead-form" ref={ref} className="section-padding bg-primary/5">
      <div className="container-custom">
        <motion.div
            ...
            <div className="md:col-span-2 space-y-6">
              <div className="bg-card rounded-2xl p-6 shadow-lg border border-border">
                ...
                <ul className="space-y-3">
                  {[
                    "Complete project brochure",
                    "Plot layouts & floor plans",
                    "Price list & payment plans",
                    "Location advantages guide",
